...
#align(center)[#image("images/1.png")]
#text(size: 12pt, align(center)[С положительным ответом])

#align(center)[#image("images/2.png")]
#text(size: 12pt, align(center)[С отрицательным ответом])

#align(center)[#image("images/3.png")]
#text(size: 12pt, align(center)[С вводимым числом A, которое выходит за границы возможных значений])

#align(center)[#image("images/4.png")]
#text(size: 12pt, align(center)[С вводимым числом B, которое выходит за границы возможных значений])

#align(center)[#image("images/5.png")]
#text(size: 12pt, align(center)[С параметром, содержащим кроме цифр другие символы])

#align(center)[#image("images/6.png")]
#text(size: 12pt, align(center)[С отрицательным параметром])
