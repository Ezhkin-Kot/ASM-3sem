...
Изначально сегментный регистр DS указывает на конец префикса программного сегмента PSP, который имеет физический размер в 0100h, и только потом в программе он инициализируется нужным адресом. Физические адреса сегментов выровнены по параграфам, а один параграф содержит 16 байтов, то есть SS смещён относительно DS на 10h.
